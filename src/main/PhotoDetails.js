...
const PhotoDetails = () => {
  ...
  return (
    <PageTemplateComponent>
      ...
      <CenterComponent>
        <div id="photo-details-photo" className="row">
          <div className="col-8">
            <div className="image-container">
              <img src={photoSrc} alt="Lights"/>
            </div>
          </div>
          <div id="photo-details-row" className="col-4">
            <div className="row comments">
              <ul className="list-group w-100">
                <li id="main-username" className="list-group-item">
                  {renderAuthorLinkTo()}
                </li>
                <hl/>
                <li id="photo-details-list" className="list-group-item">
                  {renderAuthorLinkTo()}
                  <div>----------</div>
                  <hl/>
                ...
                <hl/>
                <li id="photo-details-likes-and-comments" className="list-group-item">
                  <div className="row">
                    <button
                      type="button"
                      className=""
                ...
                <hl/>
                <li id="photo-details-textarea" className="list-group-item">
                  Dodaj komentarz:
                  <textarea
                    rows="4"
                    value={content}
