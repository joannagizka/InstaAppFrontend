    ...
    return (
      <Link to={linkTo} className="card col-md-4 thumbnail">
        ...
        <div className="card-body text-muted">
          <span className="badge badge-primary">{photo.authorUsername}</span>

          <p className="text-decoration-none">{photo.description}</p>

          <p> <svg className="bi bi-heart" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
